...
#define reportDTCSnapshotIdentification                                     STD_ON
...
extern FUNC(void,DCM_CODE) App_Read0xF18E(P2VAR(Dcm_MsgContextType,AUTOMATIC,DCM_APPL_DATA) pMsgContext);
