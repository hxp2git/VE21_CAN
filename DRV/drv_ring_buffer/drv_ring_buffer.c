 ...
 *@retval     bool
 */
bool ring_buf_init(DrvRingBufferDataStruct *r, unsigned char *buf, unsigned int len)
{
    r->buf = buf;
    r->size = len;
    r->front = r->rear = 0;
...
const DrvRingBufferInterfaceStruct g_drv_ring_buffer_interface = {
    .ring_buf_init = ring_buf_init,
    .ring_buf_clr = ring_buf_clr,
    .ring_buf_len = ring_buf_len,
    .ring_buf_put = ring_buf_put,
    .ring_buf_get = ring_buf_get,
};